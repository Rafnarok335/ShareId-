<?php
	...
	$sqlCommand="SELECT * FROM pending_post";
	$sqlResult=mysqli_query($connect,$sqlCommand);
	if($sqlResult==false)
	{
		$_SESSION['msg']="<span style='color:red'>DBMS PROB IN HOME</span>";
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			...
			echo "<h4 style='color:#409499;'>".$_SESSION['user']['admin_id']."</h4>";?>
			</div>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li   class="colorlib-active"><a href="admin-home">Home</a></li>
	    		...
	    		<div class="row d-flex">
	    			<div class="col-xl-8 py-5 px-md-5">
	    				<div class="row pt-md-4">
			    			<div class="col-md-12">
			    				<h2 style="text-align: center;margin:7px 7px 70px 7px;">PENDING POSTS</h2>
									<p style="margin: 0 auto;text-align: center;"><?php if(isset($_SESSION['msg'])!=null)
												echo $_SESSION['msg'];
												$_SESSION['msg']=null;
									...
									<div class="blog-entry ftco-animate d-md-flex">
										<table>
											...
											<tr>
												<td>Buyer&nbsp;&nbsp;&nbsp;</td><td>Seller&nbsp;&nbsp;&nbsp;</td><td>Transaction NO.</td>
											</tr>
											<?php 
											...
											?>
											<tr>
												<td><?php echo $row['buyer'] ?>&nbsp;&nbsp;&nbsp;</td><td><?php echo $row['seller'] ?>&nbsp;&nbsp;&nbsp;</td><td><?php echo $row['trans_id'] ?>&nbsp;&nbsp;&nbsp;</td><td><a href="resources/accept?b=<?php echo $row['buyer'] ?>&s=<?php echo $row['seller'] ?>&t=<?php echo $row['post_time']?>">accept</a>&nbsp;&nbsp;&nbsp;</td><td><a href="resources/decline?b=<?php echo $row['buyer'] ?>&s=<?php echo $row['seller'] ?>&t=<?php echo $row['post_time']?>">Decline</a>&nbsp;&nbsp;&nbsp;</td>
											</tr>
