	    				...
	    				<div class="row pt-md-4">
	    					<div class="col-md-12">
	    						<div class="blog-entry ftco-animate d-md-flex">
	    							<div class="text text-2 pl-md-4">
	    						         <table>
	    						         	<form method="post" action="resources/deleteprofile.php" id="form2">
	    						         	<tr>
	    						         		<td >User Name : &nbsp;&nbsp;&nbsp;</td>
	    						         		<input type="hidden" name="username" value="<?php echo $row['user_name']; ?>"><td><?php echo $row['user_name']; ?></td>
	    						         	</tr>
	    						         	<tr>
	    						         ...
	    						         <button form="form2" >Yes</button>
	    						         <button onclick="window.location='profile.php?id=<?php echo $row['user_name']; ?>'" >No </button>
	    				 		   		</form>
	    				 		       <!-- RATING START -->
