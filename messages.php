	    		...
	    		<div class="row d-flex">
	    			<div class="col-xl-8 py-5 px-md-5">
	    				<div class="row pt-md-4">
			    			<div class="col-md-12">
			    				<h2 style="text-align: center;margin: 7px;">MESSAGES</h2>
									<div class="blog-entry ftco-animate " style="max-height: 275px;overflow: scroll;overflow-x: hidden;display:block">

									<?php 
										include "resources/dbmsconn.php";
				    					$sqlCommand="SELECT *,date_format(msg_time,'%D %M ,%Y %l:%i %p') AS time_details FROM `inbox` WHERE sender='".$_GET['id']."' AND reciever='".$_SESSION['user']['user_name']."' OR reciever='".$_GET['id']."' AND sender='".$_SESSION['user']['user_name']."' ORDER BY msg_time DESC;";
									...
									?>	
										<p style="margin: 0px;color:skyblue;"><?php echo $row['sender']?></p>
										<p style="margin:0px"><?php echo $row['msg']?></p>
										<p><?php echo $row['time_details']?></p>
									<?php 
									}	
									?>
									</div>
									<div style="text-align: center;">
										<form action="resources/msg" method="post" id="msg">
											<input type="hidden" name="rec" value="<?php echo $_GET['id']; ?>">
										</form>
										<textarea form="msg" name="msg" required="" style="resize: none;width: 357px;height: 100px" placeholder="Write your message"></textarea><br>
										<button form="msg" name="send">SEND</button>	
									</div>
							</div>
