	    					...
	    					<div class="col-md-12">
	    						<div class="blog-entry ftco-animate d-md-flex">
	    							<div class="text text-2 pl-md-4">
	    						         <table>
	    						         	<tr>
	    						         		<td >User Name : &nbsp;&nbsp;&nbsp;</td><td><?php echo $row['user_name']; ?></td>
	    						         	</tr>
	    						         	<tr>
	    						            ...
	    						            <tr>
	    						         	<td> <?php if(isset($_SESSION['msg'])!=false){
	    						         		     echo $_SESSION['msg'];
	    						         		 }
	    						         		 $_SESSION['msg']=null;
	    						        ...
	    						        <?php if ($_GET['id'] == $_SESSION['user']['user_name'] ) {

	    						         ?> <button onclick="window.location='editProfile.php?id=<?php echo $row['user_name']; ?>'" >Update</button>
	    						         <button onclick="window.location='deleteprofile.php?id=<?php echo $row['user_name']; ?>'" >Delete Profile </button>
	    				 		   	<?php  } ?>
	    				 		       <!-- RATING START -->
