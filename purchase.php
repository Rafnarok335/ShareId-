	    		...
	    		<div class="row d-flex">
	    			<div class="col-xl-8 py-5 px-md-5">
	    				<?php
	    					...
	    					$sqlCommand="SELECT *,date_format(post_time,'%D %M ,%Y %l:%i %p') AS time_details FROM `posts` WHERE user_name='".$_GET['id']."' AND post_time='".$_GET['t']."' ORDER BY post_time DESC;";
	    				...
	    				<div class="row pt-md-4">
			    			<div class="col-md-12">
			    				<h2 style="text-align: center;margin: 7px;">CONFIRM YOUR PURCHASE</h2>
									<div class="blog-entry ftco-animate d-md-flex">
									<form action="resources/purchase" method="post">
										<table>
											<tr>
												<td>Transaction id:</td><td><input type="text" name="tran_id" placeholder="Enter your transaction id" required=""></td>
											</tr>
											<tr>
												<td></td><td><input type="hidden" name="seller" value="<?php echo $_GET['id']?>"></td>
											</tr>
											<tr>
												<td></td><td><input type="hidden" name="post_time" value="<?php echo $_GET['t']?>"></td>
											</tr>
											<tr>
												<td></td><td><input type="submit" name="confirm" value="confirm"></td>
											</tr>
											<tr>
												<td></td>
												<td>
