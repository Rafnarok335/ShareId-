	    		...
	    		<div class="row d-flex">
	    			<div class="col-xl-8 py-5 px-md-5">
	    				...
	    				<?php
	    					...
	    					$sqlCommand="SELECT *,date_format(post_time,'%D %M ,%Y %l:%i %p') AS time_details FROM `posts` WHERE status='NO' AND title LIKE '%".$s."%' ORDER BY post_time DESC;";
			    		...
			    		{
			    			echo "SEARCH RESULT DIDNT MATCH";
			    		}
			    		?>
